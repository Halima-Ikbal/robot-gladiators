...
var fight = function(enemyName) {
  ...
  //ask player would you like to fight or skip
  var promptFight = window.prompt('Would you like to FIGHT or SKIP this battle? Enter FIGHT or SKIP to choose.');

     // if player choses to skip
     if (promptFight ==="skip" || promptFight === "SKIPT") {
  ...
  // remove enemy's health by subtracting the amount set in the playerAttack variable
    ...
    console.log(
      playerName + ' attacked ' + enemyName + '. ' + enemyName + ' now has ' + enemyHealth + 'health rremaining.'
  ...
  if (promptFight === "fight" || promptFight === "FIGHT") {
    ...
    // remove player's helath by subtracting the amount set in the enemyAttack variable
